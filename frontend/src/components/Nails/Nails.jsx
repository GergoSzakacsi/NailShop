...
const NailsContent = [
  ...
  "A műkörömépítés célja a természetes körmök hosszabbítása esztétikusabbá tétel. Akik tartósan szép és ápolt körmökre vágynak, és a természetes körmük önmagában nem kellően erős, azok számára ideális a műköröm.",
...
function Nails() {
  return (
    <div className='ml-2'>
      ...
      <div className="row g-0 promo1">
        <div className="col-md-6 d-flex align-items-center">
          <div className='p-4 text-center'>
            ...
            <p className='text-break'>
              Első alkalommal általában célszerűbb rövidebb hosszt választani, így szépen fokozatosan hozzá fogsz tudni szokni az új körmeidhez. Ha már "gyakorlott" műkörömviselő vagy, Neked csak a képzelet szabhat határt. Amennyiben extrém formát szeretnél (Monroe, Orosz mandula, Gótikus Mandula, Pipe vagy Edge), mindenképpen előre egyeztessünk telefonon. Ezeknek a formáknak az elkészítése hosszabb folyamat, mint egy klasszikus szalon formaé, ezért fontos, hogy kellő időt szánjunk rá. Első alkalommal általában célszerűbb rövidebb hosszt választani, így szépen fokozatosan hozzá fogsz tudni szokni az új körmeidhez.
            </p>
          </div>
        </div>
        <div className="col-md-6">
      ...
      <div className='w-75 container h-100 d-flex justify-content-center align-items-center'>
        <h2>Műköröm újraépítése szalonhosszban</h2>
      </div>
